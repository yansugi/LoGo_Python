...
############################################
# setting
mail_domain = "@city.kashihara.lg.jp"  # メールドメインの初期値
groupId = "29205"  # アカウント管理グループIDの初期値
organization = "奈良県橿原市"  # 組織名の初期値
rooms = 30  # 退出する部屋数の初期値
url_login = "https://tb.logochat.st-japan.asp.lgwan.jp/signin"  # ログインページのURL
# url_login = "https://logochat.jp/signin"
############################################
...
driver.maximize_window()  # ウィンドウ最大化
...
elem_kashihara = driver.find_element(
    By.XPATH, f"//span[contains(text(),'{organization}')]"
)
elem_kashihara.click()
time.sleep(4)
